function [fitness,erfc,sd_r,md] = compute_event_exeptionality(traces,N,robust_std)
%{
...
md = max(mode_robust_gab(traces'),0);
...
z = bsxfun(@times,bsxfun(@minus,traces,md'),1./(sd_r)); % GAB
